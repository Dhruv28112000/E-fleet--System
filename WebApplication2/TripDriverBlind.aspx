<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeFile="TripDriverBlind.aspx.cs" Inherits="WebApplication2.WebForm1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      ...
      <div class="content-wrapper">
       ...
       <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Driver Blind With Vehicle Form</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              </div>
                      ...
                      <tr>
                        <td>
                         <table class="auto-style1">
                           ...
                           <tr>
                    <td> <label for="ddlmanufacturer" class="col-sm-0 col-form-label">Select Vehicle No:</label></td>
                   <td> <div>
           <asp:DropDownList ID="vecno" runat="server" Width="228px">
               
    <asp:ListItem>GJ05BZ8686</asp:ListItem>
		<asp:ListItem>GJ06TT7602</asp:ListItem>
		<asp:ListItem>GJ06VV9405</asp:ListItem>
		...
		<asp:ListItem>GJ15YY6604</asp:ListItem>
		<asp:ListItem>GJ16W6336</asp:ListItem>
		<asp:ListItem>GJ16X7018</asp:ListItem>
		<asp:ListItem>GJ16Z0200</asp:ListItem>
		<asp:ListItem>GJ16Z5508</asp:ListItem>
		<asp:ListItem>GJ16Z5509</asp:ListItem>
		<asp:ListItem>GJ16Z5510</asp:ListItem>
		<asp:ListItem>GJ22T1313</asp:ListItem>
		<asp:ListItem>GJ22T2727</asp:ListItem>
		<asp:ListItem>GJ22T3030</asp:ListItem>
		<asp:ListItem>MH04F8916</asp:ListItem>
     </asp:DropDownList>
                    </div>
                     </td>
                        </tr>
                            <tr>
                    <td> <label for="ddlmodel" class="col-sm-0 col-form-label">Select First Driver Name:</label></td>
                   <td> <div>
                        <asp:DropDownList ID="fdname" runat="server" Width="228px">
                            <asp:ListItem  value="ABDUL HAMEED">ABDUL HAMEED</asp:ListItem>          <asp:ListItem value="ABDUL JABBAR">ABDUL JABBAR</asp:ListItem>
		<asp:ListItem value="ABDUL MAJID">ABDUL MAJID</asp:ListItem>
		<asp:ListItem value="ABDUL SALAM">ABDUL SALAM</asp:ListItem>
		<asp:ListItem value="ABID ALI">ABID ALI</asp:ListItem>
		<asp:ListItem value="AINUL HASSAN">AINUL HASSAN</asp:ListItem>
		<asp:ListItem value="AKHILESH KUMAR PAL">AKHILESH KUMAR PAL</asp:ListItem>
		<asp:ListItem value="AKRAM">AKRAM</asp:ListItem>
		<asp:ListItem value="ALI AHMED">ALI AHMED</asp:ListItem>
		<asp:ListItem value="ALOK">ALOK</asp:ListItem>
		<asp:ListItem value="ANSAR HARUN KHAN">ANSAR HARUN KHAN</asp:ListItem>
		<asp:ListItem value="ARUN KUMAR">ARUN KUMAR</asp:ListItem>
		<asp:ListItem value="ARVIND KUMAR YADAV">ARVIND KUMAR YADAV</asp:ListItem>
		<asp:ListItem value="ARVIND YADAV">ARVIND YADAV</asp:ListItem>
		<asp:ListItem value="AVDESH KUMAR YADAV">AVDESH KUMAR YADAV</asp:ListItem>
		<asp:ListItem value="AWTAR POHLO RAM SINGH">AWTAR POHLO RAM SINGH</asp:ListItem>
		<asp:ListItem value="BALWANT sINGH">BALWANT sINGH</asp:ListItem>
		<asp:ListItem value="BIPIN KUMAR PAL">BIPIN KUMAR PAL</asp:ListItem>
		<asp:ListItem value="CHANDAN">CHANDAN</asp:ListItem>
		<asp:ListItem value="CHANDRA SHEKHAR PRAJAPATI">CHANDRA SHEKHAR PRAJAPATI</asp:ListItem>
		<asp:ListItem value="DAYARAM YADAV">DAYARAM YADAV</asp:ListItem>
		<asp:ListItem value="Dharmendra Yadav">Dharmendra Yadav</asp:ListItem>
		<asp:ListItem value="DHIRAJ KUMAR">DHIRAJ KUMAR</asp:ListItem>
		<asp:ListItem value="DHIRENDRA KUMAR SHOBHLAL">DHIRENDRA KUMAR SHOBHLAL</asp:ListItem>
		<asp:ListItem value="FAHIMUDDIN">FAHIMUDDIN</asp:ListItem>
		<asp:ListItem value="FAISUL HASAN">FAISUL HASAN</asp:ListItem>
		<asp:ListItem value="FATEH BAHADUR">FATEH BAHADUR</asp:ListItem>
		<asp:ListItem value="FIROZAHMED ">FIROZAHMED </asp:ListItem>
		<asp:ListItem value="GANGAPRASAD SINGH">GANGAPRASAD SINGH</asp:ListItem>
		<asp:ListItem value="Gayasuddin Salauddin">Gayasuddin Salauddin</asp:ListItem>
		<asp:ListItem value="HAMID ALI">HAMID ALI</asp:ListItem>
		<asp:ListItem value="HAMID ALI JAMILUDDIN">HAMID ALI JAMILUDDIN</asp:ListItem>
		<asp:ListItem value="IMRAN KHAN">IMRAN KHAN</asp:ListItem>
		<asp:ListItem value="Indresh Yadav">Indresh Yadav</asp:ListItem>
		<asp:ListItem value="ISLAQUDDIN ABDUL RAUF">ISLAQUDDIN ABDUL RAUF</asp:ListItem>
		<asp:ListItem value="ISLQUDDIN">ISLQUDDIN</asp:ListItem>
		<asp:ListItem value="IYANUL HASAN">IYANUL HASAN</asp:ListItem>
		<asp:ListItem value="IZHAR ALI ">IZHAR ALI </asp:ListItem>
		<asp:ListItem value="JAFRUL ">JAFRUL </asp:ListItem>
		<asp:ListItem value="JAVED KHAN">JAVED KHAN</asp:ListItem>
		<asp:ListItem value="JAY KUMAR YADAV">JAY KUMAR YADAV</asp:ListItem>
		<asp:ListItem value="JAYPAL">JAYPAL</asp:ListItem>
		<asp:ListItem value="JITENRA RANA">JITENRA RANA</asp:ListItem>
		<asp:ListItem value="KADAM KRISHNA YADAV">KADAM KRISHNA YADAV</asp:ListItem>
		<asp:ListItem value="KULDEEP PANDEY">KULDEEP PANDEY</asp:ListItem>
		<asp:ListItem value="KULWANT SINGH">KULWANT SINGH</asp:ListItem>
		<asp:ListItem value="Magan">Magan</asp:ListItem>
		<asp:ListItem value="Mahboob Alam Israil ">Mahboob Alam Israil </asp:ListItem>
		<asp:ListItem value="MAIFUZUR RAHMAN">MAIFUZUR RAHMAN</asp:ListItem>
		<asp:ListItem value="MANOJ KUMAR YADAV">MANOJ KUMAR YADAV</asp:ListItem>
		<asp:ListItem value="MOHAMMED AKRAM KHAN">MOHAMMED AKRAM KHAN</asp:ListItem>
		<asp:ListItem value="MOHAMMED HUSAIN KHAN">MOHAMMED HUSAIN KHAN</asp:ListItem>
		<asp:ListItem value="Mohd Arshad">Mohd Arshad</asp:ListItem>
		<asp:ListItem value="MOHD ASHRAF">MOHD ASHRAF</asp:ListItem>
		<asp:ListItem value="Mohd Naim">Mohd Naim</asp:ListItem>
		<asp:ListItem value="MOHD PARBES">MOHD PARBES</asp:ListItem>
		<asp:ListItem value="MOHD SAHRUKH KHAN">MOHD SAHRUKH KHAN</asp:ListItem>
		<asp:ListItem value="MOHD SALMAN KHAN">MOHD SALMAN KHAN</asp:ListItem>
		<asp:ListItem value="MOHD SALMAN RAIS">MOHD SALMAN RAIS</asp:ListItem>
		<asp:ListItem value="Mohd Sharik Abdul Jabbar">Mohd Sharik Abdul Jabbar</asp:ListItem>
		<asp:ListItem value="MOHD SIDDIQUE KHAN">MOHD SIDDIQUE KHAN</asp:ListItem>
		<asp:ListItem value="MOHD WAKIL QURESHI">MOHD WAKIL QURESHI</asp:ListItem>
		<asp:ListItem value="MOHD.AKRAM">MOHD.AKRAM</asp:ListItem>
		<asp:ListItem value="MOHD.FARUK H KHAN">MOHD.FARUK H KHAN</asp:ListItem>
		<asp:ListItem value="MOHD.HASIM">MOHD.HASIM</asp:ListItem>
		<asp:ListItem value="MOHD.IBRAR">MOHD.IBRAR</asp:ListItem>
		<asp:ListItem value="MOHD.NAFEES">MOHD.NAFEES</asp:ListItem>
		<asp:ListItem value="MOHD.SALEEM">MOHD.SALEEM</asp:ListItem>
		<asp:ListItem value="MOHD.VARISH">MOHD.VARISH</asp:ListItem>
		<asp:ListItem value="MOHSIN ALI">MOHSIN ALI</asp:ListItem>
		<asp:ListItem value="MUKESH PAL">MUKESH PAL</asp:ListItem>
		<asp:ListItem value="MUNNILA  SHARMA">MUNNILA  SHARMA</asp:ListItem>
		<asp:ListItem value="MUNNILAL SHARMA">MUNNILAL SHARMA</asp:ListItem>
		<asp:ListItem value="NARENDRA KUMAR YADAV">NARENDRA KUMAR YADAV</asp:ListItem>
		<asp:ListItem value="NASEEMUDIN">NASEEMUDIN</asp:ListItem>
		<asp:ListItem value="Neeraj Kuamr Hem Singh">Neeraj Kuamr Hem Singh</asp:ListItem>
		<asp:ListItem value="NERENDRA KUMAR THAKUR">NERENDRA KUMAR THAKUR</asp:ListItem>
		<asp:ListItem value="NIRMAL RANA">NIRMAL RANA</asp:ListItem>
		<asp:ListItem value="Nirmit">Nirmit</asp:ListItem>
		<asp:ListItem value="NOOR ALAM">NOOR ALAM</asp:ListItem>
		<asp:ListItem value="OM PRAKASH PRAJAPATI">OM PRAKASH PRAJAPATI</asp:ListItem>
		<asp:ListItem value="Pankaj Yadav">Pankaj Yadav</asp:ListItem>
		<asp:ListItem value="PARBHAT SINGH">PARBHAT SINGH</asp:ListItem>
		<asp:ListItem value="Pawan Singh">Pawan Singh</asp:ListItem>
		<asp:ListItem value="PRADEEP KUMAR">PRADEEP KUMAR</asp:ListItem>
		<asp:ListItem value="PRADEEP KUMAR PAL">PRADEEP KUMAR PAL</asp:ListItem>
		<asp:ListItem value="PRAMOD KUMAR PAL">PRAMOD KUMAR PAL</asp:ListItem>
		<asp:ListItem value="Premchand Bansilal Saroj">Premchand Bansilal Saroj</asp:ListItem>
		<asp:ListItem value="RABEENDRA KUMAR YADAV">RABEENDRA KUMAR YADAV</asp:ListItem>
		<asp:ListItem value="RABEENDRA YADAV">RABEENDRA YADAV</asp:ListItem>
		<asp:ListItem value="RAJESH KUMAR PAL">RAJESH KUMAR PAL</asp:ListItem>
		<asp:ListItem value="RAJESHKUMAR SAROJ">RAJESHKUMAR SAROJ</asp:ListItem>
		<asp:ListItem value="RAJKARAN TIWARI">RAJKARAN TIWARI</asp:ListItem>
		<asp:ListItem value="Rajkumar Maurya">Rajkumar Maurya</asp:ListItem>
		<asp:ListItem value="RAJKUMAR YADAV">RAJKUMAR YADAV</asp:ListItem>
		<asp:ListItem value="RAKESH KUMAR PRAJAPATI">RAKESH KUMAR PRAJAPATI</asp:ListItem>
		<asp:ListItem value="RAM KISHAN YADAV">RAM KISHAN YADAV</asp:ListItem>
		<asp:ListItem value="RAM KISHUN">RAM KISHUN</asp:ListItem>
		<asp:ListItem value="RAM NATH">RAM NATH</asp:ListItem>
		<asp:ListItem value="RAMAPATI NISHAD">RAMAPATI NISHAD</asp:ListItem>
		<asp:ListItem value="RAMASHRE">RAMASHRE</asp:ListItem>
		<asp:ListItem value="RAMLAL PAL">RAMLAL PAL</asp:ListItem>
		<asp:ListItem value="Ramsajeevan Yadav">Ramsajeevan Yadav</asp:ListItem>
		<asp:ListItem value="Ramsurat Saroj">Ramsurat Saroj</asp:ListItem>
		<asp:ListItem value="RANJEET YADAV">RANJEET YADAV</asp:ListItem>
		<asp:ListItem value="RAVI YADAV">RAVI YADAV</asp:ListItem>
		<asp:ListItem value="RIYAZUDDIN">RIYAZUDDIN</asp:ListItem>
		<asp:ListItem value="ROHIT">ROHIT</asp:ListItem>
		<asp:ListItem value="ROHIT PRAJAPATI">ROHIT PRAJAPATI</asp:ListItem>
		<asp:ListItem value="SAGAR VILAS CHAVAN">SAGAR VILAS CHAVAN</asp:ListItem>
		<asp:ListItem value="SAHRKH KHAN">SAHRKH KHAN</asp:ListItem>
		<asp:ListItem value="SAHRUKH KHAN">SAHRUKH KHAN</asp:ListItem>
		<asp:ListItem value="SANTOSH YADAV">SANTOSH YADAV</asp:ListItem>
		<asp:ListItem value="SATYA NARAYAN">SATYA NARAYAN</asp:ListItem>
		<asp:ListItem value="Shailendra Kumar Mishra">Shailendra Kumar Mishra</asp:ListItem>
		<asp:ListItem value="SHAYAMLAL J&amp;K">SHAYAMLAL J&amp;K</asp:ListItem>
		<asp:ListItem value="SHYAMLAL YADAV">SHYAMLAL YADAV</asp:ListItem>
		<asp:ListItem value="SILSHAD AHMED">SILSHAD AHMED</asp:ListItem>
		<asp:ListItem value="SIRAJ">SIRAJ</asp:ListItem>
		<asp:ListItem value="Sonukumar">Sonukumar</asp:ListItem>
		<asp:ListItem value="SUBASH KUMAR">SUBASH KUMAR</asp:ListItem>
		<asp:ListItem value="SUBEDAR YADAV">SUBEDAR YADAV</asp:ListItem>
		<asp:ListItem value="SUBHASHKUMAR DAYA SHANKAR SHARMA">SUBHASHKUMAR DAYA SHANKAR SHARMA</asp:ListItem>
		<asp:ListItem value="SUNIL KUMAR">SUNIL KUMAR</asp:ListItem>
		<asp:ListItem value="SUNIL KUMAR SINGH">SUNIL KUMAR SINGH</asp:ListItem>
		<asp:ListItem value="SUNIL PANDEY">SUNIL PANDEY</asp:ListItem>
		<asp:ListItem value="SURENDRA KUMAR YADAV">SURENDRA KUMAR YADAV</asp:ListItem>
		<asp:ListItem value="TAUHEED AHMED">TAUHEED AHMED</asp:ListItem>
		<asp:ListItem value="TILAK RAJ">TILAK RAJ</asp:ListItem>
		<asp:ListItem value="UDAYSHANKAR YADAV">UDAYSHANKAR YADAV</asp:ListItem>
		<asp:ListItem value="UMESH CHANDRA">UMESH CHANDRA</asp:ListItem>
		<asp:ListItem value="VIJAY KUMAR ">VIJAY KUMAR </asp:ListItem>
		<asp:ListItem value="VIJAY KUMAR MISHRA">VIJAY KUMAR MISHRA</asp:ListItem>
		<asp:ListItem value="VIJAY SINGH">VIJAY SINGH</asp:ListItem>
		<asp:ListItem value="VINAY KUMAR SINGH">VINAY KUMAR SINGH</asp:ListItem>
		<asp:ListItem value="Vishal Saroj">Vishal Saroj</asp:ListItem>
		<asp:ListItem value="VIVEK KUMAR YADAV">VIVEK KUMAR YADAV</asp:ListItem>
		<asp:ListItem value="VIVEK SINGH">VIVEK SINGH</asp:ListItem>
		<asp:ListItem value="Wajahul Hasan">Wajahul Hasan</asp:ListItem>
                           </asp:DropDownList>
                            ...
                            <tr>
                    <td> <label for="ddlcompany" class="col-sm-0 col-form-label">Select Second Driver Name:</label></td>
                   <td> <div>
                            <asp:DropDownList ID="sdname" runat="server" Width="228px" >
                             <asp:ListItem value="N/A">N/A</asp:ListItem>
		<asp:ListItem value="ABDUL HAMEED">ABDUL HAMEED</asp:ListItem>
		<asp:ListItem value="ABDUL JABBAR">ABDUL JABBAR</asp:ListItem>
		<asp:ListItem value="ABDUL MAJID">ABDUL MAJID</asp:ListItem>
		<asp:ListItem value="ABDUL SALAM">ABDUL SALAM</asp:ListItem>
		<asp:ListItem value="ABID ALI">ABID ALI</asp:ListItem>
		<asp:ListItem value="AINUL HASSAN">AINUL HASSAN</asp:ListItem>
		...
		<asp:ListItem value="Wajahul Hasan">Wajahul Hasan</asp:ListItem>
                            ...
                            <tr>
                   <td> <label for="txtchassisno" class="col-sm-0 col-form-label">Select Cleaner Name:</label></td>
                   <td> <div>
    ...
    <asp:ListItem value="N/A">N/A</asp:ListItem>
		...
		<asp:ListItem value="Wajahul Hasan">Wajahul Hasan</asp:ListItem>
                            ...
                            <tr>
                   <td ><label for="txt" class="col-sm-0 col-form-label">Select Blind date</label></td>
                   <td> <div>
                        <asp:TextBox ID="sbldate" runat="server" Width="228px"></asp:TextBox>
                    </div>
                     </td></tr>
                            <tr>
                    <td> <label for="txtmfgyear" class="col-sm-0 col-form-label">Select Route:</label></td>
                   <td> <div>
                            <asp:DropDownList ID="sroute" runat="server" Width="228px" >
		...
		<asp:ListItem value="WGL~VAP">WGL~VAP</asp:ListItem>
              ...
              <br />
                      ...
                      <input type="submit" name="btnregveh" value="Blind Driver With Vehicle" id="MainContent_ButtonSave" class="form-control" style="width:253px;" /></td>
                        
                        <td>
                          <table class="col-sm-11">
                           <tr>
                 
                   <td> <label for="ddlvehcategory" class="col-sm-0 col-form-label">Image of Driver:</label></td>
                   <td> <div>
                       <img  class="auto-style2" src="DriverImage/NoImage.png" id="image" /></div>
                     </td></tr>
