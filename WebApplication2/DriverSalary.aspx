<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeFile="DriverSalary.aspx.cs" Inherits="WebApplication2.WebForm14" %>
                    ...
                    <asp:TextBox ID="txttally" runat="server" Class="form-control" Width="228px"></asp:TextBox>
                        ...
                        <td>
                           <table class="col-sm-10" >
                             <tr><td colspan="2">
  <div style="font-size:xx-large; color:red; font-display:auto;text-align:center; font-weight:bold">Driver Salary:</div></td></tr>
                             <tr>
                                <tr>
                    <td class="auto-style1"> <label for="ddlnature" class="col-sm-0 col-form-label">Nature</label></td>
                   <td> <div>
           <asp:DropDownList ID="ddlnature" runat="server" Width="228px" class="form-control">
               <asp:ListItem>Monthely Payment</asp:ListItem>
               <asp:ListItem>Monthely Bhatta</asp:ListItem>
             <asp:ListItem>Per Km Rate</asp:ListItem>
                                    </asp:DropDownList>
                    </div>
                     </td>
                             </tr>
                           <tr>
                   <td class="auto-style5"> <label for="txtamount" class="col-sm-0 col-form-label">Amount</label></td>
                   <td> <div>
                        <asp:TextBox ID="txtamount" runat="server" Class="form-control" Width="228px"></asp:TextBox>
                    </div>
                     </td></tr>
                             <tr>
                    <td class="auto-style5"> <label for="txtissuedate" class="col-sm-0 col-form-label">Description</label></td>
                   <td> <div>
                        
                    </div><asp:TextBox ID="txtissuedate" runat="server" Width="228px" class="form-control"></asp:TextBox>
                     </td>
                        </tr>
                             <tr>
