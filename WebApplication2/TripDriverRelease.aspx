<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeFile="TripDriverRelease.aspx.cs" Inherits="WebApplication2.WebForm3" %>
   ...
   <div class="content-wrapper">
       ...
       <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Driver Realse From Vehicle Form</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              </div>
                      ...
                      <tr>
                        <td>
                         <table class="auto-style1">
                           ...
                           <tr>
                    <td> <label for="vecno" class="col-sm-0 col-form-label">Select Vehicle No:</label></td>
                   <td> <div>
           <asp:DropDownList ID="MainContent_ddlVehicleNo" runat="server" Width="228px">
	...
	<asp:ListItem value="GJ03V8100">GJ03V8100</asp:ListItem>
	<asp:ListItem value="GJ03V9898">GJ03V9898</asp:ListItem>
	...
	<asp:ListItem value="MH04JU9559">MH04JU9559</asp:ListItem>
                            ...
                            <tr>
                    <td> <label for="fdname" class="col-sm-0 col-form-label">Select First Driver Name:</label></td>
                   <td> <div>
                        <asp:DropDownList name="ctl00$MainContent$ddlfirstDriverName" ID="MainContent_ddlfirstDriverName" runat="server" Width="228px">
         	                       </asp:DropDownList>
                        </div>
                     </td>
                        </tr>
                            <tr>
                    <td> <label for="sdname" class="col-sm-0 col-form-label">Select Second Driver Name:</label></td>
                   <td> <div>
                            <asp:DropDownList ID="sdname" runat="server" Width="228px" >
                            ...
                            <tr>
                   <td> <label for="sclname" class="col-sm-0 col-form-label">Select Cleaner Name:</label></td>
                   <td> <div>
                            <asp:DropDownList ID="sclname" runat="server" Width="228px" >
    <asp:ListItem value="N/A">N/A</asp:ListItem>
		    </asp:DropDownList>
                            ...
                            <tr>
                   <td ><label for="reldate" class="col-sm-0 col-form-label">Realse Date</label></td>
                   <td> <div>
                        <asp:TextBox ID="reldate" runat="server" Width="228px" TextMode="Date"></asp:TextBox>
                    </div>
                     </td></tr>
                            <tr>
                    <td> <label for="relreason" class="col-sm-0 col-form-label">Realson Reason:</label></td>
                   <td> <div>
                            <textArea id="relresaon" cols="20" name="S1" rows="2"></textArea></div>
                     </td>
                        </tr>
              ...
              <br />
                      ...
                      <input type="submit" name="btnregveh" value="Relase Driver From Vehicle" id="MainContent_ButtonSave" class="form-control" style="width:253px;" /></td>
                     <tr>
                      <td>&nbsp;</td>
