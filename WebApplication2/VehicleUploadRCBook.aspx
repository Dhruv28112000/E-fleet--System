<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeFile="VehicleUploadRCBook.aspx.cs" Inherits="WebApplication2.VehicleUploadRCBook" %>
      ...
      <div class="content-wrapper">
       ...
       <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title" style="font-size:x-large">Vehicle RC BOOK Upload Info</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                  ...
                  <div class="col-md-12">
                      ...
                      <asp:TextBox ID="txtulw" runat="server" Class="form-control" Width="228px"></asp:TextBox>
                        ...
                        <td>
                           <table class="col-sm-10" >
                             <tr><td colspan="2">
                            <div style="font-size:xx-large; color:red; font-display:auto;text-align:center;font-weight:bold ">Upload Vehicle RC BOOK Details :</div></td></tr>
                   ...
                   <td> <div>
                           <asp:TextBox ID="txtenddate" runat="server" Class="form-control" Width="228px" TextMode="Date"></asp:TextBox>
                             ...
                             <tr>
                    <td> <label for="uplnewvehrcbookimagedoc" class="col-sm-0 col-form-label">Upload New Vehicle RC BOOK Image Doc. :</label></td>
                   <td> <div>
                       <asp:FileUpload ID="uplnewvehrcbookimagedoc" runat="server" Class="form-control" Width="228px"/>
                    </div>
                     </td>
                        </tr>
                             ...
                             <tr>                      
                      <td>
                          <asp:Button ID="btnuplnewrcbookinfo" runat="server" Text="Upload New RC Book Info." Class="form-control" BackColor="#17A2B8" Width="228px" ForeColor="White" />
                      </td>
                      </tr>
                             <tr><td>&nbsp;</td></tr>
                             <tr><td>&nbsp;</td></tr>
