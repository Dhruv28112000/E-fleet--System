<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeFile="VehicleUploadTax.aspx.cs" Inherits="WebApplication2.VehicleUploadTax" %>
    ...
    <div class="content-wrapper">
       ...
       <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title" style="font-size:x-large">Vehicle Tax Upload Info</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                  ...
                  <div class="col-md-12">
                      ...
                      <asp:TextBox ID="txtulw" runat="server" Class="form-control" Width="228px"></asp:TextBox>
                        ...
                        <td>
                           <table class="col-sm-10" >
                             <tr><td colspan="2">
                            <div style="font-size:xx-large; color:red; font-display:auto;text-align:center;font-weight:bold ">Upload Vehicle Tax Details :</div></td></tr>
                   ...
                   <td> <div>
                      <asp:TextBox ID="txtvendorname" runat="server" Class="form-control" Width="228px"></asp:TextBox>
                             ...
                             <tr>
                    <td> <label for="txtreceiptno" class="col-sm-0 col-form-label">Enter Receipt No. :</label></td>
                   <td> <div>
                   ...
                   <td> <div>
                           <asp:TextBox ID="txtenddate" runat="server" Class="form-control" Width="228px" TextMode="Date"></asp:TextBox>
                             ...
                             <tr>
                    <td> <label for="uplnewvehtaximagedoc" class="col-sm-0 col-form-label">Upload New Vehicle Tax Image Doc. :</label></td>
                   <td> <div>
                       <asp:FileUpload ID="uplnewvehtaximagedoc" runat="server" Class="form-control" Width="228px"/>
                    </div>
                     </td>
                        </tr>
                             ...
                             <tr>                      
                      <td>
                          <asp:Button ID="btnupltaxinfo" runat="server" Text="Upload Tax Information" Class="form-control" BackColor="#17A2B8" Width="228px" ForeColor="White" />
                      </td>
                      </tr>
                             <tr><td>&nbsp;</td></tr>
                             <tr><td>&nbsp;</td></tr>
