<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeFile="Misentry(2).aspx.cs" Inherits="WebApplication2.Misentry_2_" %>
              ...
              <!-- form start -->
                ...
                <div class="card-body">
                  <div class="col-md-12">
                   ...
                   <label for="txtregdate" class="col-sm-0 col-form-label">Find Vendor Name:</label>
                    <div>
                      <asp:TextBox ID="txtfindvendor" runat="server" Width="228px" class="form-control"></asp:TextBox>
                    </div>
