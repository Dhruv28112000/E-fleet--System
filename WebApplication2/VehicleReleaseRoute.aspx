<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeFile="VehicleReleaseRoute.aspx.cs" Inherits="WebApplication2.VehicleReleaseRoute" %>
   ...
   <div class="content-wrapper">
       ...
       <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title" style="font-size:x-large">Release Vehicle</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal">
                <div class="card-body">
                  <div class="col-md-12">
                   ...
                   <td> <div>
                       <asp:TextBox ID="txtbinddate" runat="server" Class="form-control" Width="228px"></asp:TextBox>
                        </div>
                     </td>
                        </tr>
                      <tr><td>
                        <label for="dtreleasedate" class="col-sm-0 col-form-label">Release Date :</label>
                        </td>
                        <td>
                       <asp:TextBox ID="dtreleasedate" runat="server" Class="form-control" Width="228px" TextMode="Date"></asp:TextBox>  
                          </td>
                        </tr>
                        <tr><td>
                         <label for="txtreason" class="col-sm-0 col-form-label">Reason :</label>
                          </td>
                          <td>
                       <asp:TextBox ID="txtreason" runat="server" Class="form-control" Width="228px"></asp:TextBox>  
