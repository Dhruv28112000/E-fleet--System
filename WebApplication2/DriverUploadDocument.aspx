<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeFile="DriverUploadDocument.aspx.cs" Inherits="WebApplication2.WebForm21" %>
                    ...
                    <asp:TextBox ID="txttally" runat="server" Class="form-control" Width="228px"></asp:TextBox>
                        ...
                        <td>
                           <table class="col-sm-10" >
                             <tr><td colspan="2">
  <div style="font-size:xx-large; color:red; font-display:auto;text-align:center; font-weight:bold">Upload Driver Necessary Document:</div></td></tr>
                             <tr>
                             <td class="auto-style4"> <label for="txtvehcode" class="col-sm-0 col-form-label">Image Type:</label></td>
                          <td class="auto-style2" align="center" valign="bottom">
               ...
               <asp:ListItem>Licence</asp:ListItem>
                            ...
                            <asp:ListItem>Adhar Card</asp:ListItem>
                             ...
                             <tr>
                             <td class="auto-style4"> <label for="txtvehcode" class="col-sm-0 col-form-label">Upload Image:</label></td>
                          <td class="auto-style2" align="center" valign="bottom">
                          <asp:Button ID="btnchoose" runat="server" Text="Choose file" Class="form-control" BackColor="#17A2B8" Width="180px" ForeColor="White" />
                            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                      </td>
                        </tr>
                              <tr><td>&nbsp;</td></tr>
                             <tr>
                               <td>
                                 <asp:Button ID="Button1" runat="server" Text="Upload Driver Image" Class="form-control" BackColor="#17A2B8" Width="191px" ForeColor="White" />
                               </td>
                             </tr>
